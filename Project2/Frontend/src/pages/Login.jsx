    ...
    <div className="min-h-screen bg-[#050505] flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-headline text-2xl font-bold tracking-tight text-white mb-2 uppercase">Researcher Login</h1>
          <p className="text-zinc-500 text-sm font-light">Enter the high-security evaluation hub</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          >
            <span className="relative z-10 transition-transform group-hover:scale-105 inline-block">Unlock Database</span>
          </button>
        </form>
        ...
        <p className="mt-10 text-zinc-500 text-[11px] text-center tracking-wide">
          Unregistered subject? <Link to="/register" className="text-primary hover:text-primary-light transition-colors font-medium">Request Hub Access</Link>
        </p>
      </motion.div>
    </div>
  );
