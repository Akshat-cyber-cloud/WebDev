  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-primary/10 blur-[130px] rounded-full animate-float mix-blend-screen"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[700px] h-[700px] bg-primary/10 blur-[150px] rounded-full animate-float-reverse mix-blend-screen"></div>
      ...
      <div className="max-w-md w-full bg-surface-container/90 backdrop-blur-xl border border-white/5 p-10 relative shadow-2xl shadow-black/50 z-10 ring-1 ring-white/10">        <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-primary to-transparent opacity-50"></div>
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="font-syne text-3xl uppercase tracking-tight text-white mb-2">Create Account</h1>
          <p className="font-dm-sans text-on-surface/40 text-sm">Initialize your researcher profile</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block font-dm-mono text-[10px] uppercase tracking-[0.2em] text-on-surface/40 mb-2">Researcher Name</label>
            <input 
              required
        ...
        <p className="mt-8 font-dm-sans text-xs text-on-surface/40 text-center">
          Already authorized? <Link to="/login" className="text-primary hover:underline">Log in to Hub</Link>
        </p>
      </div>
    </div>
  );
